        ...
        <div class="bg-container main-container-options">
          ...
          <label style="width: 100%">
            ...
            <a-select
              ...
              placeholder="Logo"
              ref="logoSelect"
              v-model:value="logoSelected"
            >
              <template
                v-for="logo in assinatura.logos"
                :key="logo.value"
              >
          ...
          >
            ...
            <a-select
              ...
              placeholder="Foto"
              ref="FotoSelect"
              v-model:value="urlFoto"
            >
              <template
                v-for="foto in fotosCs "
                :key="foto.value"
              >
          ...
          <label style="width: 100%">
            ...
            <a-select
              ...
              placeholder="Layout"
              ref="selectLayout"
              v-model:value="layoutSelected"
            >
              <template
                v-for="l in assinatura.layout"
                :key="l.text"
              >
          ...
          <fieldset class="main-container-upload">
            ...
            <label>
              ...
              <a-input
                v-model:value="nomeLogo"
                :placeholder="`${csUpload ? 'Nome da Foto': 'Nome do Logo'}`"
              />
            </label>
            <label>
              <a-upload
